...
#Download PRISM data
get_prism_annual("tmean", years = 1901:2023, keepZip = FALSE)
...
colnames(huc8_temp) <- c("HUC8", as.character(1901:2023))

#Assign annual precip to each HUC8 for period of record
count <- 1 #initialize

for(i in 1901:2023){ #period of record
  count <- count+1
