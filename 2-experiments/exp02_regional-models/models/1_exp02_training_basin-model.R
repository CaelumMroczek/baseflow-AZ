...
## for Basin & Range region (AZ)
#################################################

trainingData <- read.csv(here("2-experiments/exp02_regional-models/data/instrumented.Basin_all-predictors.csv"))
...
# Save Model
xgb.save(xgb.model, here("2-experiments/exp02_regional-models/models/xgb.basin"))

# Save Results dataframe
write.csv(results_df, here("2-experiments/exp02_regional-models/data/basin-model_results.csv"), row.names = FALSE)
